...
public class Cs203120252Week01Lab02Application {
    ...
    public static void main(String[] args) {
        SpringApplication.run(Cs203120252Week01Lab02Application.class, args);
    }
    ...
    public ResponseEntity<List<MarvelCharacter>> searchCharactersByNamePath(@PathVariable String name) {
        List<MarvelCharacter> result = new ArrayList<>();
        for (MarvelCharacter character : characters) {
            if (character.getName().toLowerCase().contains(name.toLowerCase())) {
                result.add(character);
